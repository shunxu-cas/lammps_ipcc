...
/* ----------------------------------------------------------------------
   Contributing author: Shun Xu (CNIC), Axel Kohlmeyer (Temple U)
------------------------------------------------------------------------- */
...
PairAIREBOIntel::PairAIREBOIntel(LAMMPS *lmp) :
...
double PairAIREBOIntel::bondorder_thr(int i, int j, double rij[3], double rijmag,
...
double PairAIREBOIntel::bondorderLJ_thr(int i, int j, double rij[3], double rijmag,
...
void PairAIREBOIntel::FREBO_thr(int ifrom, int ito, int evflag, int eflag,
...
void PairAIREBOIntel::FLJ_thr(int ifrom, int ito, int evflag, int eflag,
...
void PairAIREBOIntel::TORSION_thr(int ifrom, int ito, int evflag, int eflag,
...
void PairAIREBOIntel::REBO_neigh_thr()
{
  const int nthreads = comm->nthreads;
...
double PairAIREBOIntel::memory_usage()
{
